...
<head>
    ...
    <title>Contato - Loja de Roupas Nike</title>
    ...
    <main>
        <section class="contact-hero">
            <div class="contact-hero-content">
                <h1 class="contact-hero-title">Fale com a Nike</h1>
                <p class="contact-hero-desc">
                    Tem dúvidas, sugestões ou precisa de ajuda? Nossa equipe está pronta para te atender!
                </p>
                <ul class="contact-info">
                    <li><i class="bi bi-envelope"></i> contato@lojaderoupas.com</li>
                    <li><i class="bi bi-telephone"></i> (11) 1234-5678</li>
                    <li><i class="bi bi-geo-alt"></i> Rua Exemplo, 123 - São Paulo, SP</li>
                </ul>
            </div>
            <img src="../assets/images/banner-nike.jpg" alt="Equipe Nike pronta para ajudar" style="max-width:320px; border-radius:10px; box-shadow:0 4px 24px rgba(0,0,0,0.15);">
        </section>
