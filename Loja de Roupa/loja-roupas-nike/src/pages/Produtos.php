...
<head>
    ...
    <title>Produtos - Loja de Roupas Nike</title>
    ...
    <main>
        <section class="products-hero">
            <div class="products-hero-content">
                <h1 class="products-hero-title">Produtos Nike</h1>
                <p class="products-hero-desc">
                    Confira nossa seleção de produtos Nike com tecnologia, conforto e estilo para todos os momentos.
                </p>
            </div>
